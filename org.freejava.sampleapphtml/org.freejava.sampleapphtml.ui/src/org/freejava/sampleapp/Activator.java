...
public class Activator extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "org.freejava.sampleapp";
	...
	public static synchronized void logInfo(String message, Throwable ex) {
		if (message == null) message = ""; //$NON-NLS-1$
		Status errorStatus = new Status(IStatus.INFO, PLUGIN_ID, IStatus.OK, message, null);
		getDefault().getLog().log(errorStatus);
	}
}
